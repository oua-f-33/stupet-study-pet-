...
class toDoListe extends StatefulWidget {
  toDoListe({Key? key}) : super(key: key);

  @override
  State<toDoListe> createState() => toDo();
}

class toDo extends State<toDoListe> {
          ...
          body: Container(
            ...
            decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage('assets/stupet-logo.png'),
