...
class _QuestionListState extends State<QuestionList> {
  ...
  Future<void> fetchDropdownOptions() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('AYT Din').get();
  ...
  Future<void> fetchAllResults() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('Sonuç AYT Din').get();
  ...
  void printAllResults() {
    print('Tüm Sonuçlar:');
    for (var result in allResults) {
      print('Soru ${result['Soru Sayısı']}: ${result['konu']} ${result['Sonuç AYT Din']}');
    }
  }
      ...
      children: [
        ...
        ElevatedButton(
          onPressed: () {
            ...
            FirebaseFirestore.instance.collection('Sonuç AYT Din').add({
