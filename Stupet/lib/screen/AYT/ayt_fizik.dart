...
class aytFizik extends StatelessWidget {
  @override
...
class _QuestionListState extends State<QuestionList> {
  ...
  Future<void> fetchDropdownOptions() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('AYT Fizik').get();
  ...
  Future<void> fetchAllResults() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('Sonuç AYT Fizik').get();
  ...
  void printAllResults() {
    print('Tüm Sonuçlar:');
    for (var result in allResults) {
      print('Soru ${result['Soru Sayısı']}: ${result['konu']} ${result['Sonuç AYT Fizik']}');
    }
  }
      ...
      children: [
        ...
        ElevatedButton(
          onPressed: () {
            ...
            FirebaseFirestore.instance.collection('Sonuç AYT Fizik').add({
