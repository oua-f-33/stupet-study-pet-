...
class tytBiyoloji extends StatelessWidget {
  ...
  Future<List<String>> fetchDropdownOptions() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('TYT Biyoloji').get();
...
class _QuestionListState extends State<QuestionList> {
  ...
  Future<void> fetchAllResults() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('Sonuç TYT Biyoloji').get();
  ...
  void printAllResults() {
    print('Tüm Sonuçlar:');
    for (var result in allResults) {
      print('Soru ${result['Soru Sayısı']}: ${result['konu']} ${result['Sonuç TYT Biyoloji']}');
    }
  }
            ...
            Expanded(
              child: ElevatedButton(
                onPressed: () {
                  ...
                  FirebaseFirestore.instance.collection('Sonuç TYT Biyoloji').add({
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('Biyoloji Sorularınız Kaydedildi.'),
                    ),
                  );
                },
                child: Text('Kaydet'),
