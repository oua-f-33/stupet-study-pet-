...
class _QuestionListState extends State<QuestionList> {
  ...
  Future<void> fetchAllResults() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('Sonuc TYT Turkce').get();
  ...
  void printAllResults() {
    print('Tüm Sonuçlar:');
    for (var result in allResults) {
      print('Soru ${result['Soru Sayısı']}: ${result['konu']} ${result['results']}');
    }
  }
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text('Türkçe Sorularınız Kaydedildi.'),
                      ),
                    );
                  },
                  child: Text('Kaydet'),
