...
class tytTurkce extends StatelessWidget {
  @override
...
class _QuestionListState extends State<QuestionList> {
  ...
  Future<void> fetchAllResults() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('Sonuç TYT Turkce').get();
      ...
      children: [
        ...
        ElevatedButton(
          onPressed: () {
            ...
            FirebaseFirestore.instance.collection('Sonuç TYT Turkce').add({
