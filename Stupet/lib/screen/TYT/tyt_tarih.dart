...
class tytTarih extends StatelessWidget {
  ...
  Future<List<String>> fetchDropdownOptions() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('TYT Tarih').get();
...
class _QuestionListState extends State<QuestionList> {
  ...
  Future<void> fetchAllResults() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('Sonuç TYT Tarih').get();
  ...
  void printAllResults() {
    print('Tüm Sonuçlar:');
    for (var result in allResults) {
      print('Soru ${result['Soru Sayısı']}: ${result['konu']} ${result['Sonuç TYT Tarih']}');
    }
  }
            ...
            Expanded(
              child: ElevatedButton(
                onPressed: () {
                  ...
                  FirebaseFirestore.instance.collection('Sonuç TYT Tarih').add({
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('Tarih Sorularınız Kaydedildi.'),
                    ),
                  );
                },
                child: Text('Kaydet'),
