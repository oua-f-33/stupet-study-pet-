...
class tytGeometri extends StatelessWidget {
  ...
  Future<List<String>> fetchDropdownOptions() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('TYT Geometri').get();
...
class _QuestionListState extends State<QuestionList> {
  ...
  Future<void> fetchAllResults() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('Sonuç TYT Geometri').get();
  ...
  void printAllResults() {
    print('Tüm Sonuçlar:');
    for (var result in allResults) {
      print('Soru ${result['Soru Sayısı']}: ${result['konu']} ${result['Sonuç TYT Geometri']}');
    }
  }
            ...
            Expanded(
              child: ElevatedButton(
                onPressed: () {
                  ...
                  FirebaseFirestore.instance.collection('Sonuç TYT Geometri').add({
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('Geometri Sorularınız Kaydedildi.'),
                    ),
                  );
                },
                child: Text('Kaydet'),
