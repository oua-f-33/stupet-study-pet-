...
class tytFelsefe extends StatelessWidget {
  ...
  Future<List<String>> fetchDropdownOptions() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('TYT Felsefe').get();
...
class _QuestionListState extends State<QuestionList> {
  ...
  Future<void> fetchAllResults() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('Sonuç TYT Felsefe').get();
  ...
  void printAllResults() {
    print('Tüm Sonuçlar:');
    for (var result in allResults) {
      print('Soru ${result['Soru Sayısı']}: ${result['konu']} ${result['Sonuç TYT Felsefe']}');
    }
  }
            ...
            Expanded(
              child: ElevatedButton(
                onPressed: () {
                  ...
                  FirebaseFirestore.instance.collection('Sonuç TYT Felsefe').add({
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('Felsefe Sorularınız Kaydedildi.'),
                    ),
                  );
                },
                child: Text('Kaydet'),
