...
class tytKimya extends StatelessWidget {
  ...
  Future<List<String>> fetchDropdownOptions() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('TYT Kimya').get();
...
class _QuestionListState extends State<QuestionList> {
  ...
  Future<void> fetchAllResults() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('Sonuç TYT Kimya').get();
  ...
  void printAllResults() {
    print('Tüm Sonuçlar:');
    for (var result in allResults) {
      print('Soru ${result['Soru Sayısı']}: ${result['konu']} ${result['Sonuç TYT Kimya']}');
    }
  }
            ...
            Expanded(
              child: ElevatedButton(
                onPressed: () {
                  ...
                  FirebaseFirestore.instance.collection('Sonuç TYT Kimya').add({
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('Kimya Sorularınız Kaydedildi.'),
                    ),
                  );
                },
                child: Text('Kaydet'),
