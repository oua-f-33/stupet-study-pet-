...
class _selectedTYT_AYTState extends State<selectedTYT_AYT> {
  ...
  void getDailyQuote() async {
    ...
    var quote = querySnapshot.docs[randomIndex].get('name');
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => Ayt_sayisal()),);
                    },
                    child: Text('AYT-SAY'),
                  ),
                  SizedBox(width: 16),
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => Ayt_sozel()),);
                    },
                    child: Text('AYT-SÖZ'),
                  ),
            ...
            Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => Ayt_esit_agirlik()),);
                    },
                    child: Text('AYT-EA'),
                  ),
                  SizedBox(width: 16),
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => Ayt_dil_konulari()),);
                    },
                    child: Text('YDT'),
                  ),
